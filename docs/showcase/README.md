...
本目录存放 GitHub README 和项目文档使用的展示图，不作为 Cocos 客户端运行时资源目录。
...
- 产品介绍页可以使用 `readme-screens.png`、`premium-card-art.jpg`、`card-master-table-preview.png` 与 `readme-card-wall.png`。
